...
1. [CPLD Learning Resources](https://github.com/mikeroyal//CPLD-Guide#cpld-learning-resources) ⭐ 61 | 🐛 0 | 🌐 Verilog | 📅 2022-01-09

2. [CPLD Tools](https://github.com/mikeroyal//CPLD-Guide#cpld-tools) ⭐ 61 | 🐛 0 | 🌐 Verilog | 📅 2022-01-09

3. [OpenCL Development](https://github.com/mikeroyal/CPLD-Guide#opencl-development) ⭐ 61 | 🐛 0 | 🌐 Verilog | 📅 2022-01-09

4. [Virtualization Tools](https://github.com/mikeroyal/CPLD-Guide#virtualization-tools) ⭐ 61 | 🐛 0 | 🌐 Verilog | 📅 2022-01-09

5. [Emulation Tools](https://github.com/mikeroyal/CPLD-Guide#emulation-tools) ⭐ 61 | 🐛 0 | 🌐 Verilog | 📅 2022-01-09

6. [Firmware Development](https://github.com/mikeroyal/CPLD-Guide#firmware-development) ⭐ 61 | 🐛 0 | 🌐 Verilog | 📅 2022-01-09

7. [MATLAB Development](https://github.com/mikeroyal/CPLD-Guide#matlab-development) ⭐ 61 | 🐛 0 | 🌐 Verilog | 📅 2022-01-09

8. [Verilog/SystemVerilog Development](https://github.com/mikeroyal/CPLD-Guide#VerilogSystemVerilog-development) ⭐ 61 | 🐛 0 | 🌐 Verilog | 📅 2022-01-09

9. [Assembly Development](https://github.com/mikeroyal/CPLD-Guide#assembly-development) ⭐ 61 | 🐛 0 | 🌐 Verilog | 📅 2022-01-09

10. [C/C++ Development](https://github.com/mikeroyal/CPLD-Guide#cc-development) ⭐ 61 | 🐛 0 | 🌐 Verilog | 📅 2022-01-09

11. [Electric charge, field, and potential](https://github.com/mikeroyal/CPLD-Guide#electric-charge-field-and-potential) ⭐ 61 | 🐛 0 | 🌐 Verilog | 📅 2022-01-09
...
12. [Circuits](https://github.com/mikeroyal/CPLD-Guide#Circuits) ⭐ 61 | 🐛 0 | 🌐 Verilog | 📅 2022-01-09

    * Ohm's law and circuits with resistors: Circuits
    * Circuits with capacitors: Circuits

13. [Magnetic forces, magnetic fields, and Faraday's law](https://github.com/mikeroyal/CPLD-Guide#magnetic-forces-magnetic-fields-and-Faradays-law) ⭐ 61 | 🐛 0 | 🌐 Verilog | 📅 2022-01-09
...
14. [Electromagnetic waves and interference](https://github.com/mikeroyal/CPLD-Guide#electromagnetic-waves-and-interference) ⭐ 61 | 🐛 0 | 🌐 Verilog | 📅 2022-01-09
...
[Back to the Top](https://github.com/mikeroyal/CPLD-Guide#table-of-contents) ⭐ 61 | 🐛 0 | 🌐 Verilog | 📅 2022-01-09
...
[Unicorn](https://github.com/unicorn-engine/unicorn) ⭐ 9,268 | 🐛 216 | 🌐 C | 📅 2026-07-30 is a lightweight, multi-platform, multi-architecture CPU emulator framework(ARM, AArch64, M68K, Mips, Sparc, X86) based on [QEMU](https://www.qemu.org/).
...
[Cloud Hypervisor](https://github.com/cloud-hypervisor/cloud-hypervisor) ⭐ 6,148 | 🐛 223 | 🌐 Rust | 📅 2026-08-26 is an open source Virtual Machine Monitor (VMM) that runs on top of [KVM](https://www.kernel.org/doc/Documentation/virtual/kvm/api.txt). The project focuses on exclusively running modern, cloud workloads, on top of a limited set of hardware architectures and platforms. Cloud workloads refers to those that are usually run by customers inside a cloud provider. Cloud Hypervisor is implemented in [Rust](https://www.rust-lang.org/) and is based on the [rust-vmm](https://github.com/rust-vmm) crates.
...
[fwupd](https://github.com/fwupd/fwupd) ⭐ 4,130 | 🐛 111 | 🌐 C | 📅 2026-08-26 is a simple daemon to allow session software to update firmware. The goal og project is to make updating firmware on Linux automatic, safe and reliable.
...
[Firmware Manager](https://github.com/pop-os/firmware-manager) ⭐ 159 | 🐛 23 | 🌐 Rust | 📅 2025-10-27 is a generic framework and GTK UI for firmware updates from [system76-firmware](https://github.com/pop-os/system76-firmware) ⭐ 79 | 🐛 20 | 🌐 Rust | 📅 2026-08-18 and [fwupd](https://github.com/fwupd/fwupd) ⭐ 4,130 | 🐛 111 | 🌐 C | 📅 2026-08-26, written in Rust.
...
[C++ Core Guidelines](https://github.com/isocpp/CppCoreGuidelines/blob/master/CppCoreGuidelines.md) ⭐ 45,276 | 🐛 246 | 🌐 CSS | 📅 2026-08-06
...
[Azure SDK for C++](https://github.com/Azure/azure-sdk-for-cpp) ⭐ 205 | 🐛 171 | 🌐 C++ | 📅 2026-08-26
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,400 | 🐛 1,194 | 🌐 CMake | 📅 2026-08-26 is a C++ Library Manager for Windows, Linux, and MacOS.
...
* [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/CPLD-Guide/pulls) ⭐ 61 | 🐛 0 | 🌐 Verilog | 📅 2022-01-09.

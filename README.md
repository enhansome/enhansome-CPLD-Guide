...
[Apio](https://github.com/FPGAwars/apio) ⭐ 1,004 | 🐛 40 | 🌐 Python | 📅 2026-08-17 is a multiplatform toolbox, with static pre-built packages, project configuration tools and easy command interface to verify, synthesize, simulate and upload your verilog designs.
...
[Cloud Hypervisor](https://github.com/cloud-hypervisor/cloud-hypervisor) ⭐ 6,114 | 🐛 223 | 🌐 Rust | 📅 2026-08-17 is an open source Virtual Machine Monitor (VMM) that runs on top of [KVM](https://www.kernel.org/doc/Documentation/virtual/kvm/api.txt). The project focuses on exclusively running modern, cloud workloads, on top of a limited set of hardware architectures and platforms. Cloud workloads refers to those that are usually run by customers inside a cloud provider. Cloud Hypervisor is implemented in [Rust](https://www.rust-lang.org/) and is based on the [rust-vmm](https://github.com/rust-vmm) crates.
...
[Azure SDK for C++](https://github.com/Azure/azure-sdk-for-cpp) ⭐ 204 | 🐛 158 | 🌐 C++ | 📅 2026-08-17
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,369 | 🐛 1,143 | 🌐 CMake | 📅 2026-08-17 is a C++ Library Manager for Windows, Linux, and MacOS.

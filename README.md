...
[fwupd](https://github.com/fwupd/fwupd) ⭐ 4,115 | 🐛 97 | 🌐 C | 📅 2026-08-16 is a simple daemon to allow session software to update firmware. The goal og project is to make updating firmware on Linux automatic, safe and reliable.
...
[Firmware Manager](https://github.com/pop-os/firmware-manager) ⭐ 159 | 🐛 23 | 🌐 Rust | 📅 2025-10-27 is a generic framework and GTK UI for firmware updates from [system76-firmware](https://github.com/pop-os/system76-firmware) ⭐ 78 | 🐛 22 | 🌐 Rust | 📅 2026-08-13 and [fwupd](https://github.com/fwupd/fwupd) ⭐ 4,115 | 🐛 97 | 🌐 C | 📅 2026-08-16, written in Rust.
...
[C++ Core Guidelines](https://github.com/isocpp/CppCoreGuidelines/blob/master/CppCoreGuidelines.md) ⭐ 45,245 | 🐛 246 | 🌐 CSS | 📅 2026-08-06
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,367 | 🐛 1,158 | 🌐 CMake | 📅 2026-08-15 is a C++ Library Manager for Windows, Linux, and MacOS.

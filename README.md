...
[Apio](https://github.com/FPGAwars/apio) ⭐ 1,004 | 🐛 42 | 🌐 Python | 📅 2026-08-20 is a multiplatform toolbox, with static pre-built packages, project configuration tools and easy command interface to verify, synthesize, simulate and upload your verilog designs.
...
[OpenWiFi](https://github.com/open-sdr/openwifi) ⭐ 4,760 | 🐛 93 | 🌐 C | 📅 2026-08-14 is an open-source IEEE802.11/Wi-Fi baseband chip/FPGA design.
...
[Reko](https://github.com/uxmal/reko) ⭐ 2,600 | 🐛 165 | 🌐 C# | 📅 2026-08-18 is a decompiler for machine code binaries.
...
[fwupd](https://github.com/fwupd/fwupd) ⭐ 4,121 | 🐛 99 | 🌐 C | 📅 2026-08-20 is a simple daemon to allow session software to update firmware. The goal og project is to make updating firmware on Linux automatic, safe and reliable.
...
[Firmware Manager](https://github.com/pop-os/firmware-manager) ⭐ 159 | 🐛 23 | 🌐 Rust | 📅 2025-10-27 is a generic framework and GTK UI for firmware updates from [system76-firmware](https://github.com/pop-os/system76-firmware) ⭐ 78 | 🐛 21 | 🌐 Rust | 📅 2026-08-18 and [fwupd](https://github.com/fwupd/fwupd) ⭐ 4,121 | 🐛 99 | 🌐 C | 📅 2026-08-20, written in Rust.
...
[Azure SDK for C++](https://github.com/Azure/azure-sdk-for-cpp) ⭐ 204 | 🐛 162 | 🌐 C++ | 📅 2026-08-20

[Azure SDK for C](https://github.com/Azure/azure-sdk-for-c) ⚠️ Archived

[C++ Client Libraries for Google Cloud Services](https://github.com/googleapis/google-cloud-cpp) ⭐ 658 | 🐛 205 | 🌐 C++ | 📅 2026-08-20
